...
def sqlerver_wflow_run_inst(wf_runid):
    return f"select * from [D00000PD10_PWC_REP_PROD].[dbo].[REP_WFLOW_RUN_INST] where WORKFLOW_RUN_ID={wf_runid} "

#select STARTDATE, DELRECORDSTIME, TABLESTART,   TABLESTART - DELRECORDSTIME,  ENDDATE from DR_RESTORELOG where SOURCEDBNAME like 'PROD_MDW' and SEQUENCE > 1 and (TABLESTART - DELRECORDSTIME) > '00:00:59';